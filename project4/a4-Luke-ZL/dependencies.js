window.ec = window.classes.ec =
class ec extends Shape                                   // An axis set with arrows, made out of a lot of various primitives.
{ constructor()
    { super( "positions", "normals", "texture_coords" );
      ...
      this.drawOneAxis( Mat4.rotation(Math.PI/2, Vec.of(1,0,0)).times( Mat4.scale([  1, -1, 1 ])), [[ .34,.66 ], [ 0,1 ]] );
      this.drawOneAxis( Mat4.rotation( Math.PI/3, Vec.of(0,1,0)).times( Mat4.scale([ -1,  1, 1 ])), [[  0 ,.33 ], [ 0,1 ]] );
      this.drawOneAxis( Mat4.rotation( Math.PI/3*2, Vec.of(0,1,0)).times( Mat4.scale([ -1,  1, 1 ])), [[  0 ,.33 ], [ 0,1 ]] );
      this.drawOneAxis( Mat4.rotation( Math.PI, Vec.of(0,1,0)).times( Mat4.scale([ -1,  1, 1 ])), [[  0 ,.33 ], [ 0,1 ]] );
      this.drawOneAxis( Mat4.rotation( Math.PI/3*4, Vec.of(0,1,0)).times( Mat4.scale([ -1,  1, 1 ])), [[  0 ,.33 ], [ 0,1 ]] );
      this.drawOneAxis( Mat4.rotation( Math.PI/3*5, Vec.of(0,1,0)).times( Mat4.scale([ -1,  1, 1 ])), [[  0 ,.33 ], [ 0,1 ]] ); 
    }
